...
const questions = [
  ...
  {
    question: "Почему Вы снизили оценку? <br> Выберите подходящий(е) вам вариант(ы)",
    options: [
  ...
  {
    question: "Что именно вам не нравится в КАМЕРЕ? <br> Выберите подходящий(е) вам вариант(ы), если есть такое",
    options: [
  ...
  {
    question:
      "Что вам не нравится в ПРОИЗВОДИТЕЛЬНОСТИ телефона? <br> Выберите подходящий(е) вам вариант(ы), если есть такое",
    options: [
  ...
  {
    question:
      "Какие сложности, связанные с ИНТЕРФЕЙСОМ, у вас возникали? <br> Выберите подходящий(е) вам вариант(ы), если есть такое",
    options: [
  ...
  {
    question:
      "Что разочаровало вас в ЭКРАНЕ смартфона? <br> Выберите подходящий(е) вам вариант(ы), если есть такое",
    options: [
  ...
  {
    question:
      "С какими трудностями или неудобными моментами Вы столкнулись при ВЗАИМОДЕЙСТВИИ с телефоном? <br> Выберите подходящий(е) вам вариант(ы), если есть такое",
    options: [
      "Недостаточно памяти", 
  ...
  {
    question:
      'Что вам понравилось в телефоне Samsung больше всего? <br> Выберите до 3 вариантов ответа',
    options: [
      "Камера",
      "Батарея",
      "Производительность",
  ...
  {
    question: "Что вам хотелось бы улучшить в этом смартфоне? <br> Выберите до 3 вариантов ответа, если есть такое",
    options: [
      "Камера",
      "Батарея",
      "Производительность",
  ...
  {
    question:
      "Какую информацию Вы хотели бы получать от Samsung? <br> Выберите все подходящие вам варианты",
    options: [
      "Информацию о новинках",
      "Информацию о промо акциях - специальных выгодных предложениях",
      "Информацию о скидках",
      "Советы и рекомендации по пользованию вашими устройствами Samsung",
